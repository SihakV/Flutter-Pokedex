...
class DarkPokemonScreen extends StatefulWidget {
  const DarkPokemonScreen({super.key});

  @override
  State<DarkPokemonScreen> createState() => _DarkPokemonScreenState();
}

class _DarkPokemonScreenState extends State<DarkPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getDarkPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getDarkPokemon(
        page: _currentPage + 1,
      );
      setState(() {
