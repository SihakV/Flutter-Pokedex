...
class RockPokemonScreen extends StatefulWidget {
  const RockPokemonScreen({super.key});

  @override
  State<RockPokemonScreen> createState() => _RockPokemonScreenState();
}

class _RockPokemonScreenState extends State<RockPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getRockPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getRockPokemon(
        page: _currentPage + 1,
      );
      setState(() {
