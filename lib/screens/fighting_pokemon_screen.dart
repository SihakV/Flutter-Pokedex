...
class FightingPokemonScreen extends StatefulWidget {
  const FightingPokemonScreen({super.key});

  @override
  State<FightingPokemonScreen> createState() => _FightingPokemonScreenState();
}

class _FightingPokemonScreenState extends State<FightingPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getFightingPokemon(
        page: _currentPage,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fighting Pokémon'),
