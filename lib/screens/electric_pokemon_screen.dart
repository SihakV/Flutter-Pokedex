...
class ElectricPokemonScreen extends StatefulWidget {
  const ElectricPokemonScreen({super.key});

  @override
  State<ElectricPokemonScreen> createState() => _ElectricPokemonScreenState();
}

class _ElectricPokemonScreenState extends State<ElectricPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getElectricPokemon(
        page: _currentPage,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Electric Pokémon'),
