...
class SteelPokemonScreen extends StatefulWidget {
  const SteelPokemonScreen({super.key});

  @override
  State<SteelPokemonScreen> createState() => _SteelPokemonScreenState();
}

class _SteelPokemonScreenState extends State<SteelPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getSteelPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getSteelPokemon(
        page: _currentPage + 1,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Steel Pokémon'),
