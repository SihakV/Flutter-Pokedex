...
class GrassPokemonScreen extends StatefulWidget {
  const GrassPokemonScreen({super.key});

  @override
  State<GrassPokemonScreen> createState() => _GrassPokemonScreenState();
}

class _GrassPokemonScreenState extends State<GrassPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getGrassPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getGrassPokemon(
        page: _currentPage + 1,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Grass Pokémon'),
