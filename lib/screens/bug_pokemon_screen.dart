...
class BugPokemonScreen extends StatefulWidget {
  const BugPokemonScreen({super.key});

  @override
  State<BugPokemonScreen> createState() => _BugPokemonScreenState();
}

class _BugPokemonScreenState extends State<BugPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getBugPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getBugPokemon(
        page: _currentPage + 1,
      );
      setState(() {
