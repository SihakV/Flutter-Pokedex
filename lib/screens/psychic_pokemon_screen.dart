...
class PsychicPokemonScreen extends StatefulWidget {
  const PsychicPokemonScreen({super.key});

  @override
  State<PsychicPokemonScreen> createState() => _PsychicPokemonScreenState();
}

class _PsychicPokemonScreenState extends State<PsychicPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getPsychicPokemon(
        page: _currentPage,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('psychic Pokémon'),
