...
class WaterPokemonScreen extends StatefulWidget {
  const WaterPokemonScreen({super.key});

  @override
  State<WaterPokemonScreen> createState() => _WaterPokemonScreenState();
}

class _WaterPokemonScreenState extends State<WaterPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getWaterPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getWaterPokemon(
        page: _currentPage + 1,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Water Pokémon'),
