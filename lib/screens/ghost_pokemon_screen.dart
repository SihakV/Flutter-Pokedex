...
class GhostPokemonScreen extends StatefulWidget {
  const GhostPokemonScreen({super.key});

  @override
  State<GhostPokemonScreen> createState() => _GhostPokemonScreenState();
}

class _GhostPokemonScreenState extends State<GhostPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getGhostPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getGhostPokemon(
        page: _currentPage + 1,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ghost Pokémon'),
