...
class FirePokemonScreen extends StatefulWidget {
  const FirePokemonScreen({super.key});

  @override
  State<FirePokemonScreen> createState() => _FirePokemonScreenState();
}

class _FirePokemonScreenState extends State<FirePokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getFirePokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getFirePokemon(
        page: _currentPage + 1,
      );
      setState(() {
