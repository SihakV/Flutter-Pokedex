...
class FairyPokemonScreen extends StatefulWidget {
  const FairyPokemonScreen({super.key});

  @override
  State<FairyPokemonScreen> createState() => _FairyPokemonScreenState();
}

class _FairyPokemonScreenState extends State<FairyPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getFairyPokemon(page: _currentPage);
      setState(() {
  ...
  Future<void> _loadMorePokemon() async {
    ...
    try {
      final result = await _pokemonService.getFairyPokemon(
        page: _currentPage + 1,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Fairy Pokémon'),
