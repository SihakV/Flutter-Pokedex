...
class StellarPokemonScreen extends StatefulWidget {
  const StellarPokemonScreen({super.key});

  @override
  State<StellarPokemonScreen> createState() => _StellarPokemonScreenState();
}

class _StellarPokemonScreenState extends State<StellarPokemonScreen> {
  ...
  Future<void> _loadPokemon() async {
    try {
      final result = await _pokemonService.getStellarPokemon(
        page: _currentPage,
      );
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stellar Pokémon'),
